...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_NAME" name="CUST_NAME" value="Rohit Singh" /></td>
</tr>
...
<tr>	
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_STATE" name="CUST_STATE" value="Delhi" /></td>
</tr>
<tr>
...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_EMAIL" name="CUST_EMAIL" value="rohit.singh@pay10.com" /></td>
</tr>
<tr>	
...
<tr>
	<td width="50%" align="right" valign="middle">Customer Name</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_NAME" name="CUST_SHIP_NAME" value="Rohit Kumar Singh" /></td>
</tr>
...
<tr>
	<td width="50%" align="right" valign="middle">City</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_CITY" name="CUST_SHIP_CITY" value="New Delhi" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">State</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_STATE" name="CUST_SHIP_STATE" value="Delhi" /></td>
</tr>
<tr>
	<td width="50%" align="right" valign="middle">Country</td>
...
<tr>
	<td width="50%" align="right" valign="middle">Email</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_EMAIL" name="CUST_SHIP_EMAIL" value="rohit.singh@pay10.com" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Phone</td>
